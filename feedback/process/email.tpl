<table style="background-color: #f1f1f1; width:100%;" width="100%" border="0" cellpadding="0" cellspacing="0">
<tbody>
<tr>
        ...
        <table style="text-align:left; width:680px; margin:0 auto; font-size:14px; border-spacing:0px">
            ...
            <tr>
                <td bgcolor="#fff" style="padding: 15px;">
                    ...
                    Имя клиента:<b>%email.nameuser%</b>
                    <hr>
                    Телефон клиента: <b>%email.phone%</b>
                    <hr>
            ...
            <tr>
                <td bgcolor="#fff" style="padding: 20px 15px; color: #777; font-size: 14px;">
                    <p>&copy; 2018 Компания недвижимости "Millions".</p>
                </td>
            </tr>
            </tbody>
        </table>
