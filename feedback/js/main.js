...
$(function () {
     ...
     */
    var formFeedback = new ProcessForm({idForm: 'feedbackForm', existenceUploadsFile: false, existenceCaptcha: false});
    formFeedback.init();
		
	var newbuildingForm = new ProcessForm({ idForm: 'newbuildingForm', existenceCaptcha: false, existenceUploadsFile: false});
    newbuildingForm.init();
	
	var resaleForm = new ProcessForm({ idForm: 'resaleForm', existenceCaptcha: false, existenceUploadsFile: false});
    resaleForm.init();

    var newbuildingForm1 = new ProcessForm({ idForm: 'newbuildingForm1', existenceCaptcha: false, existenceUploadsFile: false});
    newbuildingForm1.init();
	
	var resaleForm1 = new ProcessForm({ idForm: 'resaleForm1', existenceCaptcha: false, existenceUploadsFile: false});
    resaleForm1.init();
	
	var questionForm = new ProcessForm({ idForm: 'questionForm', existenceCaptcha: false, existenceUploadsFile: false});
    questionForm.init();
	
    var modalarendaForm = new ProcessForm({ idForm: 'modalarendaForm', existenceUploadsFile: false, existenceCaptcha: false });
    modalarendaForm.init();
	
	var modalProdForm = new ProcessForm({ idForm: 'modalProdForm', existenceUploadsFile: false, existenceCaptcha: false });
    modalProdForm.init();
	
	var modalkomForm = new ProcessForm({ idForm: 'modalkomForm', existenceUploadsFile: false, existenceCaptcha: false });
    modalkomForm.init();
	
	var modalUprForm = new ProcessForm({ idForm: 'modalUprForm', existenceUploadsFile: false, existenceCaptcha: false });
    modalUprForm.init();	
